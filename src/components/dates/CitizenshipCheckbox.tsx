...
const CitizenshipCheckbox: React.FC<CitizenshipCheckboxProps> = ({
  ...
  return <div className="flex items-start space-x-3 pt-4 pb-4">
      ...
      <div className="flex flex-col">
        <label htmlFor="indian-citizen" className="text-sm font-medium leading-none cursor-pointer my-0 px-[2px] py-[9px]">Is the Traveller an Indian Citizen and currently in India whilst taking the policy?  ( Note: NRI, OCI/non-OCI customers should not be allowed.)</label>
