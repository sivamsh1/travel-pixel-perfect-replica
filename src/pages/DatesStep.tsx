...
const DatesStep = () => {
  ...
  return <Layout>
      ...
      <div className="flex flex-1 flex-col items-center px-px">
        ...
        <div className="w-full max-w-md space-y-6">
          {/* Date Range Picker */}
          <DateRangePicker startDate={startDate} setStartDate={setStartDate} endDate={endDate} setEndDate={setEndDate} setDuration={setDuration} onError={setDateError} />
          
          {/* Trip Duration Display */}
          <TripDurationDisplay duration={duration} />
          
          {/* Citizenship Checkbox */}
          <CitizenshipCheckbox isChecked={isIndianCitizen} onCheckedChange={handleCitizenshipChange} errorMessage={citizenError} />
          
          <div className="pt-4">
            <ActionButton onClick={handleNext} className="w-full" disabled={!startDate || !endDate || !!dateError || !isIndianCitizen}>
              NEXT
            </ActionButton>
          </div>
        </div>
